...
This project uses [commitlint](https://commitlint.js.org/) to ensure consistent commit messages following the [Conventional Commits](https://www.conventionalcommits.org/) specification.
...
The commit-msg hook will automatically validate your commit messages and reject those that don't follow the convention.
