                ...
                return (
                  ...
                  >
                    ...
                    <CardHeader>
                      ...
                      <div className="my-3">
                        {typeof price.amount === 'number' && !isNaN(price.amount) ? (
                          price.amount === 0 ? (
                            <div className="text-2xl font-semibold text-green-600">Free</div>
                          ) : (
                            <div className="flex items-baseline gap-1">
                              <span className="text-3xl font-bold">${(price.amount / 100).toFixed(0)}</span>
                              <span className="text-muted-foreground">/ {price.interval || "mo"}</span>
                            </div>
                          )
                        ) : (
                          <div className="flex items-baseline gap-1">
