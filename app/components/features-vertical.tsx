...
const AccordionTrigger = forwardRef<HTMLButtonElement, AccordionTriggerProps>(
  ({ children, className, ...props }, forwardedRef) => (
    <Accordion.Header className="flex">
      <Accordion.Trigger
        className={cn(
          "group flex flex-1 cursor-pointer items-center justify-between px-5 text-[15px] leading-none",
          className
        )}
                ...
                {data.map((item, index) => (
                  ...
                  >
                    {linePosition === "left" || linePosition === "right" ? (
                      ...
                      >
                        <div
                          ...
                          } origin-top bg-secondary transition-all ease-linear`}
                          style={{
                            transitionDuration:
                              currentIndex === index
                                ? `${collapseDelay}ms`
                    ...
                    {linePosition === "top" || linePosition === "bottom" ? (
                      ...
                      >
                        <div
                          ...
                          } origin-left bg-secondary transition-all ease-linear`}
                          style={{
                            transitionDuration:
                              currentIndex === index
                                ? `${collapseDelay}ms`
                    ...
                    <div className="flex items-center relative">
                      <div className="item-box w-12 h-12 bg-secondary/10 rounded-full sm:mx-6 mx-2 shrink-0 flex items-center justify-center">
                        {item.icon}
                      </div>
                      ...
                      <div>
                        ...
                        <AccordionTrigger className="justify-start text-left leading-6 text-[16px] pl-0 text-muted-foreground">
                          {item.content}
                        </AccordionTrigger>
                      </div>
                    </div>
